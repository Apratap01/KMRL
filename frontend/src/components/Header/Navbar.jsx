  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-lg bg-gradient-to-r from-[#03070e] to-[#050448]/80 px-6 md:px-10 py-4 flex justify-between items-center shadow-md">
      ...
      <div className="hidden md:flex space-x-8">
        ...
        <Link to="/LegalDocDashboard" className="text-white hover:text-gray-300">
          DashBoard
        </Link>
      </div>
      ...
      {user ? (
        ...
        <div className="hidden md:flex space-x-4">
          <Link
            to="/login"
            className="px-4 py-2 rounded-lg border border-gray-400 text-white hover:bg-gray-800/70"
          >
            Login
          </Link>
          <Link
